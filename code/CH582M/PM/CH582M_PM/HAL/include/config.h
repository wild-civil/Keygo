 ...
 */
/* ★ PM 测试专用: DCDC 关闭, 排除内部降压变换器作为功耗变量。
 *   官方 PM 例程博主实测 Sleep 15.45uA 是在 DCDC 关闭状态下测得的,
 *   开启 DCDC 后若 PCB 电感/退耦不符合 datasheet 要求可能异常耗电。
 *   PM 测试先关 DCDC 测出基线, 再另测 DCDC 对比。 */
#ifndef DCDC_ENABLE
...
/* ★ PM 测试: EXTREME_PARK_TEST 不启用, PM 例程独立于 Keygo 固件, 用自己的 Main.c */
